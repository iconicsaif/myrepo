	...
	<body>
		...
		<div id="show-country" class="content scaffold-show" role="main">
			...
			<ol class="property-list country">
				...
				<g:if test="${countryInstance?.shortCode}">
				<li class="fieldcontain">
					<span id="shortCode-label" class="property-label"><g:message code="country.shortCode.label" default="Short Code" /></span>
					
						<span class="property-value" aria-labelledby="shortCode-label"><g:fieldValue bean="${countryInstance}" field="shortCode"/></span>
				...
				<g:if test="${countryInstance?.isdDialingCode}">
				<li class="fieldcontain">
					<span id="isdDialingCode-label" class="property-label"><g:message code="country.isdDialingCode.label" default="Isd Dialing Code" /></span>
					
						<span class="property-value" aria-labelledby="isdDialingCode-label"><g:fieldValue bean="${countryInstance}" field="isdDialingCode"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${countryInstance?.isActive}">
				<li class="fieldcontain">
					<span id="isActive-label" class="property-label"><g:message code="country.isActive.label" default="Is Active" /></span>
					
						<span class="property-value" aria-labelledby="isActive-label"><g:formatBoolean boolean="${countryInstance?.isActive}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${countryInstance?.address}">
				<li class="fieldcontain">
					<span id="address-label" class="property-label"><g:message code="country.address.label" default="Address" /></span>
