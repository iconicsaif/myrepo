			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="isActive" title="${message(code: 'userGroup.isActive.label', default: 'Is Active')}" />
				...
				<g:each in="${userGroupInstanceList}" status="i" var="userGroupInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${userGroupInstance.isActive}" /></td>
