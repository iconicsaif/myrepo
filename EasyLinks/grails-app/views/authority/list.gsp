			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="roleTitle" title="${message(code: 'authority.roleTitle.label', default: 'Role Title')}" />
				...
				<g:each in="${authorityInstanceList}" status="i" var="authorityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${authorityInstance.id}">${fieldValue(bean: authorityInstance, field: "roleTitle")}</g:link></td>
